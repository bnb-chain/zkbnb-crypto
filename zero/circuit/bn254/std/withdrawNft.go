...
func SetWithdrawNftProofWitness(proof *zero.WithdrawNftProof, isEnabled bool) (witness WithdrawNftProofConstraints, err error) {
	if proof == nil {
...
/*
	...
	- GasAccount
		- Assets:
			- AssetGas
*/
func VerifyWithdrawNftTxParams(api API, flag Variable, nilHash Variable, tx WithdrawNftProofConstraints, accountsBefore, accountsAfter [NbAccountsPerTx]AccountConstraints) {
	// verify params
