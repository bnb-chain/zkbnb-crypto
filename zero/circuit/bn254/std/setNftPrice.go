...
type SetNftPriceProofConstraints struct {
	// commitments
	A_pk Point
	// response
...
func (circuit SetNftPriceProofConstraints) Define(api API) error {
	...
	VerifySetNftPriceProof(tool, api, &circuit, hFunc, H)
	return nil
}

/*
	VerifySetNftPriceProof verify the set nft price proof in circuit
	@api: the constraint system
	@proof: claim nft proof circuit
	@params: params for the curve tebn254
*/
func VerifySetNftPriceProof(
	tool *EccTool,
	api API,
...
func SetEmptySetNftProofWitness() (witness SetNftPriceProofConstraints) {
	// commitments
...
func SetSetNftPriceProofWitness(proof *zero.SetNftPriceProof, isEnabled bool) (witness SetNftPriceProofConstraints, err error) {
	if proof == nil {
