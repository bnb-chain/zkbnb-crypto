...
*/
func SetTransferProofWitness(proof *zero.TransferProof, isEnabled bool) (witness TransferProofConstraints, err error) {
...
func SetTransferSubProofWitness(subProof *zero.TransferSubProof) (
