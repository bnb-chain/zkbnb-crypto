...
func TestVerifyPTransferProofCircuit(t *testing.T) {
	...
	fee := uint64(1)
	relation, err := zero.NewTransferProofRelation(1, fee)
	if err != nil {
		t.Fatal(err)
	}
