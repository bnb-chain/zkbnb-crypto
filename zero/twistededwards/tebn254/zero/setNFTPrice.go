...
func ProveSetNftPrice(relation *SetNftPriceRelation) (proof *SetNftPriceProof, err error) {
	if relation == nil {
...
func (proof *SetNftPriceProof) Verify() (bool, error) {
