...
var (
	...
	EmptyAssetRoot, _ = new(big.Int).SetString("1ad6428cb589f8189740836ab468dcc08c7c104a4ab40f4d468be06507a4fa39", 16)
	//EmptyAssetRoot, _ = new(big.Int).SetString("12138698643797203920628004133272007084003722567689902222615102426987438078521", 10)
)
