...
func TestCollectPubDataFromMintNftFieldOverflow(t *testing.T) {
	...
	witness.TxInfo = MintNftTxConstraints{
		...
		ToAccountIndex:      4,
		ToL1Address:         common.FromHex("1e0b0d8c4c69d2c061ced93a60fa9f08812dcc9e804efff7f445039d7834f1e53"),
		NftIndex:            5,
...
func TestCollectPubDataFromMintNft(t *testing.T) {
	...
	witness.TxInfo = MintNftTxConstraints{
		CreatorAccountIndex: 4,
		ToAccountIndex:      4,
		ToL1Address:         common.FromHex("1e0b0d8c4c69d2c061ced93a60fa9f08812dcc9e804efff7f445039d7834f1e5"),
		NftIndex:            5,
