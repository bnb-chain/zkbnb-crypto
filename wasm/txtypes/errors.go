...
var (
	...
	ErrAssetAMinAmountTooLow      = fmt.Errorf("AssetAMinAmount should not be less than %s", minAssetAmount.String())
	ErrAssetAMinAmountTooHigh     = fmt.Errorf("AssetAMinAmount should not be larger than %s", maxAssetAmount.String())
	ErrAssetBMinAmountTooLow      = fmt.Errorf("AssetBMinAmount should not be less than %s", minAssetAmount.String())
	ErrAssetBMinAmountTooHigh     = fmt.Errorf("AssetBMinAmount should not be larger than %s", maxAssetAmount.String())
	ErrAssetAIdTooLow             = fmt.Errorf("AssetAId should not be less than %s", minAssetAmount.String())
	ErrAssetAIdTooHigh            = fmt.Errorf("AssetAId should not be larger than %s", maxAssetAmount.String())
	ErrAssetBIdTooLow             = fmt.Errorf("AssetBId should not be less than %s", minAssetAmount.String())
	ErrAssetBIdTooHigh            = fmt.Errorf("AssetBId should not be larger than %s", maxAssetAmount.String())
	ErrAssetAAmountTooLow         = fmt.Errorf("AssetAAmount should not be less than %s", minAssetAmount.String())
	ErrAssetAAmountTooHigh        = fmt.Errorf("AssetAAmount should not be larger than %s", maxAssetAmount.String())
	ErrAssetBAmountTooLow         = fmt.Errorf("AssetBAmount should not be less than %s", minAssetAmount.String())
	ErrAssetBAmountTooHigh        = fmt.Errorf("AssetBAmount should not be larger than %s", maxAssetAmount.String())
