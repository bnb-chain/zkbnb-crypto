...
func (txInfo *TransferNftTxInfo) GetL1Signature() string {
...
func (txInfo *TransferNftTxInfo) GetL1AddressBySignatureInfo() (common.Address, common.Address) {
...
func (txInfo *TransferNftTxInfo) Hash(hFunc hash.Hash) (msgHash []byte, err error) {
	...
	msgHash = Poseidon(ChainId, TxTypeTransferNft, txInfo.FromAccountIndex, txInfo.Nonce, txInfo.ExpiredAt,
		txInfo.GasFeeAssetId, packedFee, txInfo.ToAccountIndex, txInfo.NftIndex, PaddingAddressToBytes32(txInfo.ToL1Address),
		txInfo.CallDataHash)
	return msgHash, nil
}
