...
func TestAtomicMatchSegmentFormat(t *testing.T) {
	...
	var segmentFormat *txtypes.AtomicMatchSegmentFormat
	segmentFormat = &txtypes.AtomicMatchSegmentFormat{
		AccountIndex:      0,
	...
	var OfferTx *txtypes.OfferTxInfo
	...
	_, err = txtypes.ConstructAtomicMatchTxInfo(sk, atomicSig)
	assert.Nil(t, err)
}
