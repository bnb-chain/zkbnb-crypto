...
func FromRemoveLiquiditySegmentJSON(segmentStr string) (segment *RemoveLiquiditySegment, err error) {
	...
	if segmentFormat.C_u_LP == "" || segmentFormat.C_fee == "" || segmentFormat.Pk_u == "" ||
		...
		return nil, errors.New("[FromRemoveLiquiditySegmentJSON] invalid params")
	}
	// verify params
