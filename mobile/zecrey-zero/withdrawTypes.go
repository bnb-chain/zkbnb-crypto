...
func FromWithdrawSegmentJSON(segmentStr string) (segment *WithdrawSegment, err error) {
	...
	if segmentFormat.C == "" || segmentFormat.Pk == "" ||
		...
		return nil, errors.New("[FromWithdrawSegmentJSON] invalid params")
	}
	// verify params
	...
	if !isValid {
		log.Println("[FromWithdrawSegmentJSON] invalid params")
		return nil, errors.New("[FromWithdrawSegmentJSON] invalid private key")
	}
