...
func NewPureAbiEncoder(context Context) (AbiEncoder, error) {
	...
	encoder := &pureAbiEncoder{a, context}
...
func (e *pureAbiEncoder) HintDefaultAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
...
func (e *pureAbiEncoder) HintTransferAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	bs := make([]byte, 0)
	bs32 := [32]byte{}
	nh := make([]byte, 0)
	nh32 := [32]byte{}
	...
	bytes, err := e.ABI.Pack("Transfer", uint32(inputs[0].Uint64()), uint32(inputs[1].Uint64()), nh32, uint16(inputs[34].Uint64()), inputs[35], uint32(inputs[36].Uint64()), uint16(inputs[37].Uint64()), uint16(inputs[38].Uint64()), bs32, uint32(inputs[71].Uint64()), uint32(inputs[72].Uint64()), uint32(inputs[73].Uint64()))
	if err != nil {
		return err
	}
	for i := range results {
...
func (e *pureAbiEncoder) HintWithdrawAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	aa := make([]byte, 0)
	aa16 := [16]byte{}
	ta := make([]byte, 0)
	ta32 := [32]byte{}
	...
	bytes, err := e.ABI.Pack("Withdraw", (uint32)(inputs[0].Uint64()), (uint16)(inputs[0].Uint64()), aa16, (uint32)(inputs[18].Uint64()), (uint16)(inputs[19].Uint64()), (uint16)(inputs[20].Uint64()), ta32, (uint32)(inputs[53].Uint64()), (uint32)(inputs[54].Uint64()), (uint32)(inputs[55].Uint64()))
...
func (e *pureAbiEncoder) HintAddLiquidityAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	bytes, err := e.ABI.Pack("AddLiquidity", (uint32)(inputs[0].Uint64()), (uint16)(inputs[1].Uint64()), inputs[2], inputs[3], (uint32)(inputs[4].Uint64()), (uint16)(inputs[5].Uint64()), (uint16)(inputs[6].Uint64()), (uint32)(inputs[7].Uint64()), (uint32)(inputs[8].Uint64()), (uint32)(inputs[9].Uint64()))
...
func (e *pureAbiEncoder) HintRemoveLiquidityAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	bytes, err := e.ABI.Pack("RemoveLiquidity", (uint32)(inputs[0].Uint64()), (uint16)(inputs[1].Uint64()), inputs[2], inputs[3], inputs[4], (uint32)(inputs[5].Uint64()), (uint16)(inputs[6].Uint64()), (uint16)(inputs[7].Uint64()), (uint32)(inputs[8].Uint64()), (uint32)(inputs[9].Uint64()), (uint32)(inputs[10].Uint64()))
...
func (e *pureAbiEncoder) HintSwapAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	bytes, err := e.ABI.Pack("Swap", (uint32)(inputs[0].Uint64()), (uint16)(inputs[1].Uint64()), inputs[2], inputs[3], (uint32)(inputs[4].Uint64()), (uint16)(inputs[5].Uint64()), (uint16)(inputs[6].Uint64()), (uint32)(inputs[7].Uint64()), (uint32)(inputs[8].Uint64()), (uint32)(inputs[9].Uint64()))
	if err != nil {
		return err
	}
	for i := range results {
...
func (e *pureAbiEncoder) HintCreateCollectionAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	bytes, err := e.ABI.Pack("CreateCollection", (uint32)(inputs[0].Uint64()), (uint32)(inputs[1].Uint64()), (uint16)(inputs[2].Uint64()), (uint16)(inputs[3].Uint64()), (uint32)(inputs[4].Uint64()), (uint32)(inputs[5].Uint64()), (uint32)(inputs[6].Uint64()))
	if err != nil {
		return err
	}
	for i := range results {
...
func (e *pureAbiEncoder) HintWithdrawNftAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	ta := make([]byte, 0)
	ta32 := [32]byte{}
	...
	copy(ta32[:], ta)
	bytes, err := e.ABI.Pack("WithdrawNft", (uint32)(inputs[0].Uint64()), inputs[1], ta32, (uint32)(inputs[34].Uint64()), (uint16)(inputs[35].Uint64()), (uint16)(inputs[36].Uint64()), (uint32)(inputs[37].Uint64()), (uint32)(inputs[38].Uint64()), (uint32)(inputs[39].Uint64()))
	if err != nil {
		return err
	}
	for i := range results {
...
func (e *pureAbiEncoder) HintTransferNftAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	ta := make([]byte, 0)
	ta32 := [32]byte{}
	...
	bytes, err := e.ABI.Pack("TransferNft", (uint32)(inputs[0].Uint64()), (uint32)(inputs[1].Uint64()), ta32, inputs[34], (uint32)(inputs[35].Uint64()), (uint16)(inputs[36].Uint64()), (uint16)(inputs[37].Uint64()), ch32, (uint32)(inputs[70].Uint64()), (uint32)(inputs[71].Uint64()), (uint32)(inputs[72].Uint64()))
	if err != nil {
		return err
	}
	for i := range results {
...
func (e *pureAbiEncoder) HintMintNftAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	ta := make([]byte, 0)
	ta32 := [32]byte{}
	...
	copy(ch32[:], ta)
	bytes, err := e.ABI.Pack("MintNft", (uint32)(inputs[0].Uint64()), (uint32)(inputs[1].Uint64()), ta32, ch32, (uint32)(inputs[68].Uint64()), (uint16)(inputs[69].Uint64()), (uint16)(inputs[70].Uint64()), (uint32)(inputs[71].Uint64()), (uint32)(inputs[72].Uint64()), (uint32)(inputs[73].Uint64()), (uint32)(inputs[74].Uint64()), (uint32)(inputs[75].Uint64()))
	if err != nil {
		return err
	}
	for i := range results {
...
func (e *pureAbiEncoder) HintCancelOfferAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {
	bytes, err := e.ABI.Pack("CancelOffer", (uint32)(inputs[0].Uint64()), inputs[1], (uint32)(inputs[2].Uint64()), (uint16)(inputs[3].Uint64()), (uint16)(inputs[4].Uint64()), (uint32)(inputs[5].Uint64()), (uint32)(inputs[6].Uint64()), (uint32)(inputs[7].Uint64()))
	if err != nil {
		return err
	}
	for i := range results {
...
func (e *pureAbiEncoder) HintAtomicMatchAbi(curveId ecc.ID, inputs []*big.Int, results []*big.Int) error {

	buyerOffer := ReadOfferFromArrays(inputs[1:72])
	sellerOffer := ReadOfferFromArrays(inputs[72:143])
	bytes, err := e.ABI.Pack("AtomicMatch", (uint32)(inputs[0].Uint64()), buyerOffer, sellerOffer, (uint32)(inputs[143].Uint64()), (uint16)(inputs[144].Uint64()), (uint16)(inputs[145].Uint64()), (uint32)(inputs[146].Uint64()), (uint32)(inputs[147].Uint64()), (uint32)(inputs[148].Uint64()))
	if err != nil {
		return err
	}
	for i := range results {
